...
def get_args_parser():
    ...
    parser.add_argument('--grad_accumulation', action='store_true', help='applied gradient accumulation')
    parser.add_argument('--shape_adapter', action='store_true')
    parser.add_argument('--ratio_weight', action='store_true')
...
def main(args):
    ...
    prompt_names = []
    # if args.ratio_weight:
    #     prompt_names.append('ratio_weight')
    if args.shape_adapter:
        # prompt_names.append('shape_adapter')
        # prompt_names.append('shape_adapter_xiaoyu1')
        # prompt_names.append('shape_adapter_dayu1')
        if args.num_adapters >= 1:
            prompt_names.append('shape_adapter_1')
        if args.num_adapters >= 2:
            prompt_names.append('shape_adapter_2')
        if args.num_adapters >= 4:
            prompt_names.append('shape_adapter_3')
            prompt_names.append('shape_adapter_4')
        if args.num_adapters >= 10:
            prompt_names.append('shape_adapter_5')
            prompt_names.append('shape_adapter_6')
            prompt_names.append('shape_adapter_7')
            prompt_names.append('shape_adapter_8')
            prompt_names.append('shape_adapter_9')
            prompt_names.append('shape_adapter_10')
        if args.num_adapters >= 1:
            prompt_names.append('shape_adapter_11')
            prompt_names.append('shape_adapter_12')
            prompt_names.append('shape_adapter_13')
            prompt_names.append('shape_adapter_14')
            prompt_names.append('shape_adapter_15')
            prompt_names.append('shape_adapter_16')
            prompt_names.append('shape_adapter_17')
            prompt_names.append('shape_adapter_18')
            prompt_names.append('shape_adapter_19')
            prompt_names.append('shape_adapter_20')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, criterion, data_loader_train, optimizer, device, epoch, args.clip_max_norm, args=args, accumulation_steps = accumulation_steps
        )
        lr_scheduler.step()
